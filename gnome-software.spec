...
* Thu Sep 10 2026 Milan Crha <mcrha@redhat.com> - 51.0-1
- Update to 51.0

* Fri Aug 28 2026 Milan Crha <mcrha@redhat.com> - 51~rc-1
- Update to 51.rc

* Wed Aug 12 2026 Petr Písař <ppisar@redhat.com> - 51~beta-3
- Remove unused build dependency on libdnf

* Mon Aug 03 2026 Milan Crha <mcrha@redhat.com> - 51~beta-2
- BuildRequire libglib-testing only when webapps are built

* Fri Jul 31 2026 Milan Crha <mcrha@redhat.com> - 51~beta-1
- Update to 51.beta

* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 51~alpha-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Fri Jun 26 2026 Milan Crha <mcrha@redhat.com> - 51~alpha-1
- Update to 51.alpha

* Mon Jun 01 2026 Milan Crha <mcrha@redhat.com> - 50.2-2
- Resolves: #2463990 (Package updates sometimes shown an online (flatpak)
  updates)

* Fri May 22 2026 Milan Crha <mcrha@redhat.com> - 50.2-1
- Update to 50.2

* Mon May 11 2026 Milan Crha <mcrha@redhat.com> - 50.1-5
- dnf5: Clamp historical updates time

* Mon May 04 2026 Milan Crha <mcrha@redhat.com> - 50.1-4
- dnf5: Make sure there is always a listener on
  Base::repo_key_import_request signal

* Wed Apr 29 2026 Milan Crha <mcrha@redhat.com> - 50.1-3
- Resolves: #2463519 (dnf5: Handle import key signal during read_all_repos
  call)

* Wed Apr 22 2026 Milan Crha <mcrha@redhat.com> - 50.1-2
- Add patch to differentiate between prepared and scheduled updates
- Helps rhbz#2457884

* Mon Apr 13 2026 Milan Crha <mcrha@redhat.com> - 50.1-1
- Update to 50.1

* Wed Mar 25 2026 Jan Grulich <jgrulich@redhat.com> - 50.0-5
- Add configuration for release-monitoring

* Mon Mar 16 2026 Milan Crha <mcrha@redhat.com> - 50.0-2
- dnf5-plugin: Close session asynchronously to speed up some calls

* Fri Mar 13 2026 Milan Crha <mcrha@redhat.com> - 50.0-1
- Update to 50.0

* Fri Feb 27 2026 Milan Crha <mcrha@redhat.com> - 50~rc-1
- Update to 50.rc

* Mon Feb 16 2026 Milan Crha <mcrha@redhat.com> - 50~beta-7
- dnf5-plugin: Update the dnf5 plugin with the recent upstream fixes
- reload package information after repository is enabled
- change when repository GPG keys are auto-accepted
- show fedora-third-party repositories in their section

* Thu Feb 12 2026 Milan Crha <mcrha@redhat.com> - 50~beta-6
- dnf5-plugin: Do not hide "updates-testing" repository

* Thu Feb 12 2026 Milan Crha <mcrha@redhat.com> - 50~beta-5
- Add patch to adapt apps after refine, to be able to uninstall them

* Fri Feb 06 2026 Milan Crha <mcrha@redhat.com> - 50~beta-4
- dnf5-plugin: Use a temporary session when checking key source before
  import

* Tue Feb 03 2026 Milan Crha <mcrha@redhat.com> - 50~beta-3
- Add patch to show "Updated" notification also for plain package updates

* Fri Jan 30 2026 Milan Crha <mcrha@redhat.com> - 50~beta-1
- Update to 50.beta

* Fri Jan 16 2026 Milan Crha <mcrha@redhat.com> - 50~alpha-1
- Update to 50.alpha

* Mon Jan 12 2026 Milan Crha <mcrha@redhat.com> - 49.3-1
- Update to 49.3

* Mon Nov 24 2025 Milan Crha <mcrha@redhat.com> - 49.2-2
- Add patch for bug #2416542 (Crash under gs_flatpak_refine_wildcard())

* Fri Nov 21 2025 Milan Crha <mcrha@redhat.com> - 49.2-1
- Update to 49.2

* Fri Oct 10 2025 Yanko Kaneti <yaneti@declera.com> - 49.1-2
- Add NEWS to docs
